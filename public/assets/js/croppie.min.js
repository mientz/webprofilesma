! function (e, t) {
    ...
    function s(e, t, n) {
        var i, o = t || new Image;
        return o.src === e ? i = new Promise(function (e) {
            e(o)
        }) : (i = new Promise(function (t) {
            n && "http" === e.substring(0, 4).toLowerCase() && o.setAttribute("crossOrigin", "anonymous"), o.onload = function () {
                setTimeout(function () {
                    t(o)
                }, 1)
            }
        }), o.src = e), o.style.opacity = 0, i
    }
    ...
    function g() {
        var e = this,
            ...
            r = D.parse(e.elements.preview.style[P]),
            a = new q(e.elements.preview),
        ...
        var p = {};
        p[W] = u.x + "px " + u.y + "px", p[P] = r.toString(), o(e.elements.preview, p)
    }
    ...
    function w() {
        function e(e, t) {
            var n = d.elements.preview.getBoundingClientRect(),
                i = h.y + t,
                o = h.x + e;
            d.options.enforceBoundary ? (p.top > n.top + t && p.bottom < n.bottom + t && (h.y = i), p.left > n.left + e && p.right < n.right + e && (h.x = o)) : (h.y = i, h.x = o)
        }
        ...
        function t(e) {
            ...
            if (!e.shiftKey || e.keyCode != o && e.keyCode != a) {
                if (e.keyCode >= 37 && e.keyCode <= 40) {
                    e.preventDefault();
                    var l = t(e.keyCode);
                    h = D.parse(d.elements.preview), document.body.style[H] = "none", p = d.elements.viewport.getBoundingClientRect(), n(l)
                }
            } else {
                var s = 0;
        ...
        function n(t) {
            var n = t[0],
                i = t[1],
                r = {};
            e(n, i), r[P] = h.toString(), o(d.elements.preview, r), y.call(d), document.body.style[H] = "", g.call(d), b.call(d), c = 0
        }
        ...
        function r(e) {
            if (e.preventDefault(), !f) {
                ...
                h = D.parse(d.elements.preview), window.addEventListener("mousemove", a), window.addEventListener("touchmove", a), window.addEventListener("mouseup", l), window.addEventListener("touchend", l), document.body.style[H] = "none", p = d.elements.viewport.getBoundingClientRect()
            }
        }
        ...
        function a(t) {
            ...
            e(l, p), f[P] = h.toString(), o(d.elements.preview, f), y.call(d), u = r, s = n
        }

        function l() {
            f = !1, window.removeEventListener("mousemove", a), window.removeEventListener("touchmove", a), window.removeEventListener("mouseup", l), window.removeEventListener("touchend", l), document.body.style[H] = "", g.call(d), b.call(d), c = 0
        }
        var s, u, c, p, h, d = this,
            f = !1;
    ...
    function C() {
        var e, t, n, r, a, l = this,
            ...
            c = 1,
            p = {},
            h = l.elements.preview,
            d = l.elements.zoomer,
            f = new D(0, 0, c),
            v = new q,
            w = x.call(l);
        if (w && !l.data.bound) {
            if (l.data.bound = !0, p[P] = f.toString(), p[W] = v.toString(), p.opacity = 1, o(h, p), e = h.getBoundingClientRect(), t = l.elements.viewport.getBoundingClientRect(), n = l.elements.boundary.getBoundingClientRect(), l._originalImageWidth = e.width, l._originalImageHeight = e.height, l.options.enableZoom) {
            ...
            f.scale = l._currentZoom, p[P] = f.toString(), o(h, p), l.data.points.length ? E.call(l, l.data.points) : _.call(l), g.call(l), y.call(l)
        }
    }
    ...
    function E(e) {
        ...
        var t = this,
            ...
            p = -1 * e[0] + a.left,
            h = {};
        h[W] = u + "px " + s + "px", h[P] = new D(p, c, l).toString(), o(t.elements.preview, h), m.call(t, l), t._currentZoom = l
    }
    ...
    function I(e) {
        var t = this,
            ...
            m = 0,
            d = 0;
        return e.outputWidth && e.outputHeight && (p = e.outputWidth, h = e.outputHeight), u.width = p, u.height = h, e.backgroundColor && (c.fillStyle = e.backgroundColor, c.fillRect(0, 0, p, h)), 0 > i && (m = Math.abs(i), i = 0), 0 > o && (d = Math.abs(o), o = 0), i + r > t._originalImageWidth && (r = t._originalImageWidth - i, p = r), o + a > t._originalImageHeight && (a = t._originalImageHeight - o, h = a), c.drawImage(this.elements.preview, i, o, r, a, m, d, p, h), s && (c.fillStyle = "#fff", c.globalCompositeOperation = "destination-in", c.beginPath(), c.arc(p / 2, h / 2, p / 2, 0, 2 * Math.PI, !0), c.closePath(), c.fill()), u
    }
    ...
    function Z(e) {
        return I.call(this, e).toDataURL(e.format, e.quality)
    }

    function L(e) {
        var t = this;
        return new Promise(function (n) {
            I.call(t, e).toBlob(function (e) {
                n(e)
            }, e.format, e.quality)
        })
    }
    ...
    function M(e, t) {
        ...
        var a = s(n, i.elements.img, i.options.useCanvas);
    ...
    function k(e) {
        var n, i = this,
            ...
            m = h.width / h.height;
        return "viewport" === l ? (o.outputWidth = h.width, o.outputHeight = h.height) : "object" == typeof l && (l.width && l.height ? (o.outputWidth = l.width, o.outputHeight = l.height) : l.width ? (o.outputWidth = l.width, o.outputHeight = l.width / m) : l.height && (o.outputWidth = l.height * m, o.outputHeight = l.height)), G.indexOf(s) > -1 && (o.format = "image/" + s, o.quality = u), o.circle = p, o.url = i.data.url, o.backgroundColor = c, n = new Promise(function (e) {
    ...
    function z(e, n) {
        if (this.element = e, this.options = t(t({}, z.defaults), n), "img" === this.element.tagName.toLowerCase()) {
            var i = this.element;
    ...
    var W, P, H, N = ["Webkit", "Moz", "ms"],
        O = document.createElement("div").style;
    P = e("transform"), W = e("transformOrigin"), H = e("userSelect");
    var A = "translate3d",
        T = ", 0px",
        D = function (e, t, n) {
    ...
    D.parse = function (e) {
        return e.style ? D.parse(e.style[P]) : e.indexOf("matrix") > -1 || e.indexOf("none") > -1 ? D.fromMatrix(e) : D.fromString(e)
    }, D.fromMatrix = function (e) {
        var t = e.substring(7).split(",");
        return t.length && "none" !== e || (t = [1, 0, 0, 1, 0, 0]), new D(l(t[4]), l(t[5]), parseFloat(t[0]))
    ...
    var q = function (e) {
        if (!e || !e.style[W]) return this.x = 0, void(this.y = 0);
        var t = e.style[W].split(" ");
    ...
    }), exports.Croppie = window.Croppie = z, "object" == typeof module && module.exports && (module.exports = z)
});
